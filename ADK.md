...
<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7346742234089738240?compact=1" height="399" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>
...
3. View the agent by listing out agents
...
## Adding in Langflow
<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7394963536256516096?compact=1" height="399" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe></br>

1. Create a connection
`uv run orchestrate connections add --app-id LFAPP`
2. Condigure an environment and key value pairs for mcp servers
...
4. Import the exported tool from Langflow 
...
2. Specify the credentials placeholder
`uv run orchestrate connections configure -a anthropic_credentials --env draft -k key_value -t team`
3. Set the credentials - replace with your api key here
`uv run orchestrate connections set-credentials -a anthropic_credentials --env draft -e "api_key=YOURAPIKEYHERE"`
...
N.B. You can also add in other providers e.g. watsonx.ai
...
1. Get your Langfuse apikey and public get from the instance, once you create a project you'll have these provided. 
2. Replace the api key and public key in this. 
...
- Stopping the server and resetting  </br>
`uv run orchestrate server stop`
`uv run orchestrate server reset`
- Viewing server logs </br>
`uv run orchestrate server logs`


# More Stuff
## Importing External Agents via A2A
<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7442052561966186496?compact=1" height="399" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>
Code: https://github.com/nicknochnack/WatsonxOrchestrateExternalAgents 

## Importing Copilot Agents into Watsonx Orchestrate 
<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7460214632683651072?compact=1" height="399" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>
